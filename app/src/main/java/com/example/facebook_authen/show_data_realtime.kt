...
import android.widget.Adapter as Apapter

/**
 * A simple [Fragment] subclass.
 */
class show_data_realtime : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {

        val view = inflater.inflate(R.layout.fragment_show_data_realtime, container, false)
